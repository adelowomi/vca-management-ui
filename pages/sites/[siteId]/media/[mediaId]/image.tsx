...
export default function ImageView({ media, token,profile }) {
      ...
      <div className="flex flex-col mx-10 mt-10">
        ...
        <div className="flex flex-col">
          ...
          <div>
            ...
            <div>
              <div className="font-semibold text-base mb-4 mt-4 text-vca-grey-1">
                Extra-large:
              </div>
              <img
                src={media.data.image.xLarge}
                alt="extra large media image"
              />
            </div>
            <div>
              <div className="font-semibold text-base mb-4 mt-4 text-vca-grey-1">
              ...
              <img src={media.data.image.large} alt="large media image" />
            </div>
            <div>
              <div className="font-semibold text-base mb-4 mt-4 text-vca-grey-1">
                Medium:
              </div>
              <img src={media.data.image.medium} alt="medium media image" />
            </div>
            <div>
              <div className="font-semibold text-base mb-4 mt-4 text-vca-grey-1">
                Small:
              </div>
              <img src={media.data.image.small} alt="medium media image" />
            </div>
          </div>
        </div>
      </div>
