...
const editPage = ({ page }) => {
  ...
  const [updatePage] = useMutation(EDIT_PAGE);
  ...
  const [state, setState] = React.useState({
    ...
    actionText: page.hero.actoinText,
    bodyTitle: '',
    bodyDescription: '',
    ctaLink: page.hero.actoinSlug,
    headerType: '',
    tags: page.tags,
  ...
  const onButtonClick = (e: any) => {
    setHeader(e.target.dataset.headertype);
  };
...
export async function getServerSideProps(ctx) {
  ...
  const {
    ...
    query: PAGE_QUERY,
    variables: { siteId: siteId, pageId: pageId },
  });
